...
<head>
    ...
    <script src="/static/assets/js/jquery.SuperSlide.2.1.1.source.js"></script>
    ...
    <div class="header-box">
        ...
        <ul class="header-right">
            <c:if test="${tbUser != null}">
                <li class="denglu">Hi~ ${tbUser.username} 欢迎回来 <a href="/logout" class="red">[注销]</a></li>
            </c:if>
            <c:if test="${tbUser == null}">
                <li class="denglu">Hi~<a class="red" href="/login" target="_blank">请登录!</a> <a href="/register" target="_blank">[免费注册]</a></li>
            </c:if>
            <li class="shu"></li>
...
<div id="lunbo">
    <ul id="one">
        <c:forEach items="${ppt}" var="ppt">
            <li><a href=""><img src="${ppt.pic}" title="${ppt.title}" alt="${ppt.title}"></a></li>
        </c:forEach>
    </ul>
    <ul id="two">
