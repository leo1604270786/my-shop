...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>
                ${tbContentCategory.id == null ? "新增" : "编辑"}分类
                <small></small>
            </h1>
            <ol class="breadcrumb">
                    ...
                    <form:form id="inputForm" cssClass="form-horizontal" action="/content/category/save" method="post" modelAttribute="tbContentCategory">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <form:hidden id="parentId" path="parentNode.id" />
                                    <input id="categoryName" class="form-control" placeholder="请选择父级类目" readonly="true" data-toggle="modal" data-target="#modal-default" value="${tbContentCategory.parentNode.name}"/>
                                </div>
                            </div>
                            <div class="form-group">
